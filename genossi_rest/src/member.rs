...
#[openapi(
    ...
    components(schemas(MemberTO, genossi_rest_types::SalutationTO, genossi_rest_types::MemberStatusTO, MemberImportResultTO, genossi_rest_types::MemberImportErrorTO, MemberImportUpload)),
