...
mod tests {
    ...
    async fn test_csv_upload_create_new_products() {
        ...
        let result: CsvImportResult = response
            .json()
            .await
...
4260474470041,Macadamia original,Macadamia orig,130g,0,\"5,39\"";
        ...
        let response1 = ctx
            .upload_csv(initial_csv)
            .await
            .expect("Failed to upload initial CSV");
...
4260474470041,Macadamia süss salzig UPDATED,Macadamia UPDATED,150g,9,\"6,49\"";
        ...
        let response2 = ctx
            .upload_csv(updated_csv)
            .await
            .expect("Failed to upload update CSV");
...
4260474470058,Cashew NEW,Cashew NEW,200g,9,\"7,89\"";
        ...
        let response = ctx
            .upload_csv(mixed_csv)
            .await
            .expect("Failed to upload mixed CSV");
...
4260474470044,Product4,P4,100g,0,\"15,50\"";
        ...
        let prices: HashMap<&str, i64> = products
            .iter()
