...
mod tests {
    ...
    impl TestContext {
        ...
        async fn update_person_with_version(
            &self,
            person: &PersonTO,
            name: &str,
            age: i32,
    ...
    async fn test_e2e_update_person() {
        ...
        let updated = ctx
            .update_person_with_version(&created, "Updated Name", 21)
            .await;
    ...
    async fn test_e2e_update_nonexistent_person() {
        ...
        let result = ctx
            .update_person_with_version(&fake_person, "Should Fail", 99)
            .await;
    ...
    async fn test_e2e_create_multiple_and_verify_isolation() {
        ...
        assert_eq!(
            persons.len(),
            0,
            "Each test should start with empty database"
        );
