...
Inventurly is an inventory management web application built with Dioxus (Rust-based web framework). It manages products, persons, and permissions with a clean REST API backend integration.
