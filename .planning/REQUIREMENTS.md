...
- [x] **APTPL-04**: Template-Validierung für Application-Vorlagen schlägt bei unbekannten/Member-only-Platzhaltern kontrolliert fehl (kein `strict`-Render-Crash beim Versand); die ~40 bestehenden Member-Template-Tests bleiben grün.
