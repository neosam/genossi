...
- [ ] 31-02-PLAN.md — Service: `send_mail` (CR-02, echtes `Result`, single-recipient) + `preview_mail` (geteilter Kernel, D-06) + `last_sent_at` (MAX über `get_application_communications`) + Service-Unit-Tests (APMAIL-01/02, APCMP-01/02, APHIST-02)
