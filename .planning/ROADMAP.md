...
|---|-------|------|------|--------------|
| 14 | DAO/Domain Foundation | Pure-Function für H1/H2-Stichtag, neue DAO-Queries (`find_by_member_and_phase`, `list_transfer_recipients`), REST-Endpoint für Transfer-Recipients-Search | 2 | 3–4 |
