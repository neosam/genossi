...
- [x] 02-08-PLAN.md — E2E-Tests (HLPR-04 Race via tokio::join, HLPR-05 Cascade-pragma, HLPR-06 Listing+Revoke+Conflicts, HLPR-07 Audit-Chain)
...
- [x] 06-04-PLAN.md — Frontend `ExportTab` inline-Component + `api::export_attendance_url` + i18n (DE+EN) + Human-Verify-Checkpoint (D-09, D-15, D-19, D-20)
