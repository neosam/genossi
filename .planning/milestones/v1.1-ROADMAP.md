...
**Wave 2** *(blocked on Wave 1)*
- [x] 12-03-PLAN.md — router routes + top_bar NavItem + page stubs
- [x] 12-04-PLAN.md — repayment_phases page (UI-01) + Create-Modal

**Wave 3** *(blocked on Wave 2)*
- [x] 12-05-PLAN.md — repayment_phase_details skeleton (UI-02) — TabStrip + BasicsTab Lifecycle + Close-Confirm + 409-Body-Parse

**Wave 4** *(blocked on Wave 3 — parallel: 12-06 touches details, 12-07 touches component layer)*
- [x] 12-06-PLAN.md — share_value Inline-Edit (D-05 PHAS-04)
- [x] 12-07-PLAN.md — editable_share_count_cell component (D-13)

**Wave 5** *(blocked on Wave 4)*
- [x] 12-08-PLAN.md — repayment_entry_list component (UI-03) — Multi-Select + Filter + Inline-Edit + Detail-Page-Mount

**Wave 6** *(blocked on Wave 5)*
- [x] 12-09-PLAN.md — repayment_entry_add_modal (UI-04) + Detail-Page-Wire

**Wave 7** *(blocked on Wave 6)*
- [x] 12-10-PLAN.md — repayment_entry_paidout_confirm (UI-05) + Sequential-Loop + Detail-Page-Wire

**Wave 8** *(blocked on Wave 7 — parallel: 12-11 component, 12-12 mail-page; no file overlap)*
- [x] 12-11-PLAN.md — TemplateVarButtons +show_repayment_vars prop (D-19)
- [x] 12-12-PLAN.md — mail_page query-param parsing + send_bulk_mail body (D-18)

**Wave 9** *(blocked on Wave 8)*
- [x] 12-13-PLAN.md — Detail-Page on_mail_request wiring (Mail-Redirect-URL)
...
| 13. RepaymentLetter-Bulk-Anschreiben für Nicht-Email-Mitglieder | (additiv) | 7/7 | Complete    | 2026-06-02 |
...
*Last updated: 2026-06-01 after Phase 13 planning — 7 plans across 6 waves cover BRIEF-01 (11 user-locked decisions D-13-01..11 fully traced); milestone v1.1 ist abgeschlossen (48/48 plans complete), Phase 13 ist additive Folge-Phase auf Phase 12.*
