...
**Verification depth scales with `asvs_level`** (see @/home/neosam/programming/rust/projects/genossi3/.claude/gsd-core/references/security-asvs-levels.md for full definitions):
