...
The keys live in `.claude/settings.json` (project) or `/home/neosam/programming/rust/projects/genossi3/.claude/settings.json` (global) — **not** in `.planning/config.json`:
