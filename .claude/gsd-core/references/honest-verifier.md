...
`@/home/neosam/programming/rust/projects/genossi3/.claude/gsd-core/references/edge-probe.md` (which *classifies* non-inferable checks) and
`@/home/neosam/programming/rust/projects/genossi3/.claude/gsd-core/references/prohibition-probe.md` (whose judgment-tier disposition this mirrors).
