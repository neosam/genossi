...
INSTALL_JS_GLOBAL="/home/neosam/programming/rust/projects/genossi3/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/neosam/programming/rust/projects/genossi3/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
