...
```
Agent(
  prompt="Read /home/neosam/programming/rust/projects/genossi3/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/neosam/programming/rust/projects/genossi3/.claude/gsd-core/templates/SECURITY.md`
