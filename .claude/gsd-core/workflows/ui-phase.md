...
```markdown
Read /home/neosam/programming/rust/projects/genossi3/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /home/neosam/programming/rust/projects/genossi3/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read /home/neosam/programming/rust/projects/genossi3/.claude/agents/gsd-ui-checker.md for instructions.
...
@/home/neosam/programming/rust/projects/genossi3/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / /home/neosam/programming/rust/projects/genossi3/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "/home/neosam/programming/rust/projects/genossi3/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "/home/neosam/programming/rust/projects/genossi3/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
