...
- **Global scope**: `/home/neosam/programming/rust/projects/genossi3/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/neosam/programming/rust/projects/genossi3/.claude/notes/`)
...
2. Glob `/home/neosam/programming/rust/projects/genossi3/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/neosam/programming/rust/projects/genossi3/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/neosam/programming/rust/projects/genossi3/.claude/notes/` — works in any directory
