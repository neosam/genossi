...
```bash
INIT=$(node "/home/neosam/programming/rust/projects/genossi3/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/neosam/programming/rust/projects/genossi3/.claude/get-shit-done/templates/spec.md.
