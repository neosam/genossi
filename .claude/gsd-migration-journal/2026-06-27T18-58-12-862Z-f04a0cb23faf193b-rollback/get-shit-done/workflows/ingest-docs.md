...
```bash
INIT=$(node "/home/neosam/programming/rust/projects/genossi3/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/neosam/programming/rust/projects/genossi3/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
