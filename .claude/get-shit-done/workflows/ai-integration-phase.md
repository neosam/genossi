...
<required_reading>
@/home/neosam/programming/rust/projects/genossi3/.claude/get-shit-done/references/ai-frameworks.md
@/home/neosam/programming/rust/projects/genossi3/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
Copy template:
```bash
cp "/home/neosam/programming/rust/projects/genossi3/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
