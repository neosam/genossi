...
Provide a CodeMirror 6 code editor integration for the frontend, including the JS bundle, Typst WASM parser, global JS interop API, Rust wasm-bindgen bindings, and the build tooling to produce these assets.
