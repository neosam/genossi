...
Import members from Excel (.xlsx) files via a REST API endpoint, with column mapping by header name, upsert by member number, tolerant date parsing, and structured error reporting.
