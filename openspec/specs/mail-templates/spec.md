...
Provide CRUD management of reusable email templates (MiniJinja subject and body) so that users can save, list, update, and delete mail templates, and use them to pre-fill the mail composition form. Includes predefined templates seeded via migration.
