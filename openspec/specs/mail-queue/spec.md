...
Background mail processing system using a job/recipient queue model. Mail jobs group recipients for bulk sending, and a background worker processes them asynchronously with configurable pacing.
