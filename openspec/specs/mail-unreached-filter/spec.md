# Mail Unreached Members Filter

## Purpose

Filter the member list to show only members that were not successfully reached by a specific mail job, enabling follow-up communication with unreached members.
