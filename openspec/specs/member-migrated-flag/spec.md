...
Track whether a member's action history has been fully migrated from the legacy system, with automatic recalculation when actions or member data change.
