...
Typst-based PDF rendering engine that compiles templates with member data into PDF documents, including variable binding, import resolution, and font provisioning.
