...
Lange Konfigurations- und Detailseiten im Frontend werden durch ein- und ausklappbare Sektionen übersichtlich gehalten. Eine wiederverwendbare Dioxus-Komponente `CollapsibleSection` kapselt einen klickbaren Header mit Titel und einen ein-/ausklappbaren Inhaltsbereich. Erstanwendung ist die Konfigurationsseite (`/config`).
