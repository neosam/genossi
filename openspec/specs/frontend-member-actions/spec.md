...
Frontend support for member actions: type definitions, API functions, action list/create/edit/delete UI on the member detail page, migration status display, and i18n.
