...
Admin-facing management UI for mail templates, providing a two-column list-detail page at `/mail/templates` for creating, editing, and deleting mail templates backed by the `/api/mail/templates` endpoints.
