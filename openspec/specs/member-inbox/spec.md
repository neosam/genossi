...
Shared IMAP inbox integration that fetches inbound emails, stores them locally, and allows users to assign mails to members, archive, or ignore them. Provides both REST API and frontend UI.
